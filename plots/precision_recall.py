...
ax.set_title('Konfusionsmatrix (AML-Beispiel)', fontsize=12, fontweight='bold')
...
ax.plot(recall_vals, precision_vals, 'b-', linewidth=2.5, label='Modell')
...
ax.scatter([0.95], [0.45], c='#E74C3C', s=100, zorder=5, label='Hoher Recall\n(wenig FN)')
ax.scatter([0.90], [0.75], c='#9B59B6', s=100, zorder=5, label='Balanced')
